...
4. [Ошибки, установка, дополнение](https://github.com/AlexNerru/GotoBot#Про-ошибки-и-баги).
...
## Про установку
Скачиваем репозиторий и запускаем EchoBot.py (да, название с начала разработки я так и не поменял) через Pycharm например, в остальном проблем возникнуть не должно. Необходим Pyhton 3.6, поддержка aqlite и выход в интернет.
