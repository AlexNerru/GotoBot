...
### /quest
Конечно же квест. Последовательность вопросов с проверкой ответа, в которую доступ происходит по логину и паролю команды. Логин и пароль команды, вопросы и ответы к ним записаны в отдельном файле, чтобы их легче было менять. Файл quest.txt
>/quest
...
## Про ошибки и баги
Большинство ошибок на неверный ввод, последовательность команд и прочее я стараюсь отлавливать, может случится, что появится ошибка, которая необработана, прошу писать мне на Github или в Telegram в таком случае.

Обрабатываются ошибки:
-Неверный ввод
-Ошибки бд
-Одновременный ввод
-Отправка команды вместо текста
-Другие
